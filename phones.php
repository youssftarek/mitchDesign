...
<h2 class="text-center" style="margin-top: 3vw;">Mobile Phones</h2><br><br>            
...
<div class="col-mid-12" style= "padding: 0px 0px 25px;">
    <div class="row" style="--bs-gutter-x: 0px;">
        ...
        <input type="hidden" name="<?= $products['title'];?>" value="<?= $products['title'];?>">
        <img src="<?=$products['image'];?>" alt="<?=$products['title'];?>">
        <!-- <input type="hidden" name="<?=$products['image'];?>" value="<?=$products['image'];?>"> -->
        <input type="hidden" name="<?= $products['title'];?>" value="1">
        ...
        <button type = "submit" name="Add_To_Cart" class = "btn btn-success" data-toggle="modal" data-target = "#order-1">Add To Cart</button>

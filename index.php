...
<h2 class="text-center" style="margin-top: 3vw;">Most Trending</h2><br><br>            
...
<div class="col-mid-12" style= "padding: 0px 0px 25px;">
    <div class="row" style="--bs-gutter-x: 0px;">
        ...
        <a href="order.php">
            <button type = "button" class = "btn btn-success" data-toggle="modal" data-target = "#order-1">Add</button>
        </a>
        </div>
        </div>
        <?php endwhile;?>
